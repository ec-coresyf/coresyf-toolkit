...
The original code developed for desktop deployment is adapted here for the initial steps of integrating it into the Co-ReSyF platform.
...
# execfile("C:/PythonF/00_PythonMusings/20180626_CalculatingSeparability/SeparabilityCalculator_20180811_V1.1_forCoReSyF.py")
